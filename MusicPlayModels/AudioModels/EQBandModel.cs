...
{
    public class EQBandModel : BaseModel, ICloneable
    {
        ...
        public EQBandModel(int band, double centerFrequency, double bandWidth, double gain)
        {
            Band = band;
        ...
        public EQBandModel(int band, double bandWidth)
        {
            Band = band;
            BandWidth = bandWidth;
        }
