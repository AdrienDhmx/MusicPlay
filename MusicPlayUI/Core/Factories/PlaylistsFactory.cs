...
namespace MusicPlayUI.Core.Factories
{
    public static class PlaylistsFactory
    {
        public static Playlist CreateFavoritePlaylist()
        {
            ...
            playlist.PlaylistTracks = new(Track.GetFavorites().ToOrderedTracks<PlaylistTrack>());
        ...
        public static Playlist CreateLastPlayedPlaylist()
        {
            Playlist playlist = new Playlist();
            ...
            playlist.PlaylistTracks = new(Track.GetLastPlayed(50).ToOrderedTracks<PlaylistTrack>()); //(await DataAccess.Connection.GetLastPlayedTracks(100)).ToOrderedTrackModel();
            return playlist;
        }

        public static Playlist CreateMostPlayedPlaylist()
        {
            Playlist playlist = new Playlist();
            ...
            playlist.PlaylistTracks = new(Track.GetMostPlayed(50).ToOrderedTracks<PlaylistTrack>()); //(await DataAccess.Connection.GetMostPlayedTracks(50)).ToOrderedTrackModel();
            return playlist;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static List<Playlist> GetConstAutoPlaylists()
        {
            List<Playlist> playlists = new()
            {
                CreateFavoritePlaylist(),
                CreateLastPlayedPlaylist(),
