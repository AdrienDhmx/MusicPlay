...
namespace MusicPlay.Database.Migrations
{
    ...
    [Migration("20240107141938_Init_4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicPlay.Database.Models.OrderedTrack", b =>
                {
                    b.HasBaseType("MusicPlay.Database.Models.Track");
                    ...
                    b.HasDiscriminator().HasValue("OrderedTrack");
                });
            ...
            modelBuilder.Entity("MusicPlay.Database.Models.Queue", b =>
                {
                    b.HasOne("MusicPlay.Database.Models.Track", "PlayingTrack")
                        .WithOne()
                        .HasForeignKey("MusicPlay.Database.Models.Queue", "PlayingTrackId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .IsRequired();
            ...
            modelBuilder.Entity("MusicPlay.Database.Models.OrderedTrack", b =>
                {
                    b.HasOne("MusicPlay.Database.Models.Queue", null)
                        .WithMany("Tracks")
                        .HasForeignKey("QueueId");
                });
