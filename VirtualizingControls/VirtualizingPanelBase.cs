    ...
    public abstract class VirtualizingPanelBase : VirtualizingPanel, IScrollInfo
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            else
            {
                ...
                if(ItemsOwner is VirtualizingItemsControl virtualizingItemsControl)
                {
                    CacheLength = new(virtualizingItemsControl.CacheLength);
                    CacheLengthUnit = virtualizingItemsControl.CacheLengthUnit;
                }
                else
                {
